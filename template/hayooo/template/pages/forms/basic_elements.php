        ...
        <ul class="nav">
            ...
            <div class="profile-desc">
              ...
              <div class="dropdown-menu dropdown-menu-right sidebar-dropdown preview-list" aria-labelledby="profile-dropdown">
                ...
                <a href="#" class="dropdown-item preview-item">
                  <div class="preview-thumbnail">
                    <div class="preview-icon bg-dark rounded-circle">
                      <i class="mdi mdi-onealamat  text-info"></i>
                    </div>
                  </div>
                  <div class="preview-item-content">
                    <p class="preview-subject ellipsis mb-1 text-small">Change alamat</p>
                  </div>
                </a>
                <div class="dropdown-divider"></div>
                <a href="#" class="dropdown-item preview-item">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="../../pages/forms/basic_elements.php">
              ...
              <span class="menu-title">Form Register</span>
            </a>
          </li>
          <li class="nav-item menu-items">
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Form Register </h3>
            ...
            <div class="row">
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <p class="card-description"> Tambahkan Data Member </p>
                    <form class="forms-sample" action="../../../../../proses_tambah_member.php" method="post">
                      <div class="form-group">
                        <label for="exampleInputNama">Nama</label>
                        <input type="text" class="form-control" id="exampleInputNama" name="nama" placeholder="Name">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputnama">nama</label>
                      ...
                      <div class="form-group">
                        ...
                        <select name="gender" class="form-control" id="exampleInputGender"  >
                          <option selected="selected"> <b>Gender</b> </option>
                          <option value="L">Laki-laki</option>
                          <option value="P">Perempuan</option>
                        </select>
                      </div>
                      <div class="form-group">
                        <label for="exampleInputtlp">No.Telp</label>
                        <input type="text" class="form-control"  id="exampleInputtlp" name="tlp" placeholder="No.telp">
                      </div>
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Tampil Data Member</h4>
                    <p class="card-description"> Data Member </p>
                    <form class="forms-sample" action="tampil_member.php">
