...
<head>
    ...
    <style>
        ...
        *[]:hover, *[]:focus, td:hover *[], td:focus *[], img.hover { background: #DEF; box-shadow: 0 0 1em 0.5em #DEF; }
        ...
        th { background: #DDA0DD; border-color: #8A2BE2; }
        td { border-color: #BA55D3; }
        ...
        header h1 { background: #800080; border-radius: 0.25em; color: #FFF; margin: 0 0 1em; padding: 0.5em 0; }
...
<body>
    <?php
        ...
        $sql = "SELECT transaksi.*, paket.jenis, paket.harga, users.username, member.nama, member.alamat, member.tlp, detail_transaksi.qty
                FROM transaksi
                JOIN users ON user.id_users = transaksi.id_users
                ...
                WHERE transaksi.id_transaksi = $tr_id";
                //echo $sql;
    ...
    ?>
		<header>
			<h1>EXPRESS LAUNDRY</h1>
			<address >
				<p>Member name :<?php echo $data['nama']; ?></p>
				<p>Address     :<?php echo $data['alamat']; ?></p>
				<p>Telephone   :<?php echo $data['tlp']; ?></p>
			</address>
		...
		<article>
			<h1>Recipient</h1>
			<address >
				<p>DETAIL transaksi LAUNDRY</p>
			</address>
			<table class="meta">
				<tr>
					<th><span >transaksi Id</span></th>
